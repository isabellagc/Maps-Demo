...
public class MapDemoActivity extends AppCompatActivity implements GoogleMap.OnMapLongClickListener{
    ...
    */
    ...
    public void onMapLongClick(LatLng point) {
        ...
        showAlertDialogFor(point);
    }

    private void dropPinEffect(final Marker marker){
        // Handler allows us to repeat a code block after after a specified delay
        final android.os.Handler handler = new android.os.Handler();
        final long start = SystemClock.uptimeMillis();
        final long duration = 1000  ;

        // uses bounce interpolator
        final android.view.animation.Interpolator interpolator = new BounceInterpolator();

        // Animate marker with a bounce, update its position every 15ms
    ...
    private void showAlertDialogFor(final LatLng point){
        ...
        alertDialog.setButton(DialogInterface.BUTTON_POSITIVE, "OK", new DialogInterface.OnClickListener(){
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                //creates and add the marker to map
